...
public final class ImageUtil {
	...
	public static BufferedImage copy(BufferedImage src, BufferedImage dst) {
		...
		g2.setRenderingHints(RenderingConfig.QUALITY.getRenderingHints());
	...
	public static BufferedImage load(String filePath) throws FileNotFoundException, ContentsIOException {
		...
		Graphics2D g2 = createGraphics2D(newImage, RenderingConfig.QUALITY);
	 ...
	 */
	public static Graphics2D createGraphics2D(BufferedImage image, RenderingConfig renderingPolicy) {
	...
	public static BufferedImage lineUp(BufferedImage... images)
		...
		g.setRenderingHints(RenderingConfig.QUALITY.getRenderingHints());
	...
	public static BufferedImage rotate(BufferedImage src, float deg, BufferedImage dst) {
		...
		Graphics2D g = createGraphics2D(dst, RenderingConfig.QUALITY);
	...
	public static BufferedImage resize(BufferedImage src, int w, int h) {
		...
		Graphics2D g2 = createGraphics2D(dst, RenderingConfig.QUALITY);
